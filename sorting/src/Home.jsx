    ...
    <div className="bg-[#fff9f4] min-h-screen text-gray-900">
          ...
          <div className="flex justify-center items-center gap-10 m-5">
            ...
            >
              ...
              <option value="Whisketiers">Whisketiers</option>
              <option value="Whittakers">Whittakers</option>
              <option value="Rhine Valley">Rhine Valley</option>
              ...
              <option value="Werther's">Werther's</option>
              <option value="Kinder">Kinder</option>
              <option value="Hershey's">Hershey's</option>
              <option value="Leonidas">Leonidas</option>
              <option value="After Eight">After Eight</option>
            </select>
          ...
          <Card products={sortedData} addToCart={addToCart} />
